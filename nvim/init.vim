...
let mapleader="\,"              " Set leader key to be comma rather than the default \
...
Plug 'tpope/vim-surround'                       " vim motion to change surround character/pattern
Plug 'tpope/vim-repeat'                         " repeat non-native motions with . key
Plug 'shaunsingh/nord.nvim'                     " color scheme nord
