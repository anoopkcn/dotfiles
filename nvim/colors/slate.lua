...
h("Directory",    c.blue,   nil)
h("Title",        c.blue,   nil,             "bold")
...
h("Identifier",     c.fg)
h("Function",       c.cyan)
h("Statement",      c.purple, nil, "bold")
h("Conditional",    c.purple, nil, "bold")
h("Repeat",         c.purple, nil, "bold")
h("Label",          c.yellow)
h("Operator",       c.fdim)
h("Keyword",        c.purple, nil, "bold")
h("Exception",      c.purple, nil, "bold")
h("PreProc",        c.yellow)
h("Include",        c.purple, nil, "bold")
h("Define",         c.yellow)
h("Macro",          c.yellow)
...
h("Debug",          c.red)
h("Underlined",     c.blue,    nil, "underline")
h("Bold",           nil,       nil, "bold")
...
h("@type.qualifier",      c.purple, nil, "bold")
...
-- Treesitter: keywords
h("@keyword",             c.purple, nil, "bold")
h("@keyword.function",    c.purple, nil, "bold")
h("@keyword.operator",    c.purple, nil, "bold")
h("@keyword.return",      c.purple, nil, "bold")
h("@keyword.conditional", c.purple, nil, "bold")
h("@keyword.repeat",      c.purple, nil, "bold")
h("@keyword.exception",   c.purple, nil, "bold")
h("@keyword.import",      c.purple, nil, "bold")
h("@keyword.coroutine",   c.purple, nil, "bold")
h("@keyword.debug",       c.purple, nil, "bold")
...
h("@comment.note",        c.blue)
-- Treesitter: markup (markdown etc.)
h("@markup.heading",       c.blue,   nil, "bold")
h("@markup.heading.1",     c.blue,   nil, "bold")
...
h("@markup.heading.6",     c.purple, nil, "bold")
...
h("@markup.link",          c.blue,   nil, "underline")
h("@markup.link.url",      c.cyan,   nil, "underline")
h("@markup.link.label",    c.blue)
