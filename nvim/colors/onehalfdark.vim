...
call s:h("PmenuBorder", s:hoverborder, s:hovercolor, "")
call s:h("NormalFloat", s:fg, s:hovercolor, "")
call s:h("FloatBorder", s:hoverborder, s:hovercolor, "")
call s:h("LspInfoBorder", s:hoverborder, s:hovercolor, "")
call s:h("DiagnosticFloatingError", s:red, s:hovercolor, "")
call s:h("DiagnosticFloatingWarn", s:yellow, s:hovercolor, "")
call s:h("DiagnosticFloatingInfo", s:blue, s:hovercolor, "")
call s:h("DiagnosticFloatingHint", s:cyan, s:hovercolor, "")
call s:h("CmpDocumentation", s:fg, s:hovercolor, "")
call s:h("CmpDocumentationBorder", s:hoverborder, s:hovercolor, "")
call s:h("FloatTitle", s:fg, s:hovercolor, "bold")
...
call s:h("BlinkCmpScrollBarThumb", "", s:hoverborder, "")
call s:h("BlinkCmpScrollBarGutter", "", s:selection, "")
call s:h("BlinkCmpMenu", s:fg, s:hovercolor, "")
call s:h("BlinkCmpMenuBorder", s:hoverborder, s:hovercolor, "")
call s:h("BlinkCmpMenuSelection", s:bg, s:blue, "")
call s:h("BlinkCmpDoc", s:fg, s:hovercolor, "")
call s:h("BlinkCmpDocBorder", s:hoverborder, s:hovercolor, "")
call s:h("BlinkCmpDocSeparator", s:hoverborder, s:hovercolor, "")
call s:h("BlinkCmpDocCursorLine", s:fg, s:selection, "")
call s:h("BlinkCmpSignatureHelp", s:fg, s:hovercolor, "")
call s:h("BlinkCmpSignatureHelpBorder", s:hoverborder, s:hovercolor, "")
