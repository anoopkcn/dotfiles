...
call s:h("PmenuSel", s:fg, s:cursor_line, "bold")
...
call s:h("@punctuation.special.markdown", s:gutter_fg, "", "")
call s:h("@punctuation.special", s:gutter_fg, "", "")
call s:h("@markup.list.markdown", s:gutter_fg, "", "")
call s:h("markdownRule", s:gutter_fg, "", "")
