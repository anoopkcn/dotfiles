...
let s:popup_bg = { "gui": "#282c34", "cterm": "236" }
let s:popup_border = { "gui": "#5c6370", "cterm": "241" }
let s:popup_selection = { "gui": "#414753", "cterm": "239" }
...
call s:h("Pmenu", s:fg, s:popup_bg, "")
call s:h("PmenuSel", s:bg, s:blue, "")
call s:h("PmenuSbar", "", s:popup_selection, "")
call s:h("PmenuThumb", "", s:popup_border, "")
call s:h("PmenuBorder", s:popup_border, s:popup_bg, "")
call s:h("PmenuKind", s:cyan, s:popup_bg, "")
call s:h("PmenuKindSel", s:popup_bg, s:blue, "")
call s:h("PmenuExtra", s:comment_fg, s:popup_bg, "")
call s:h("PmenuExtraSel", s:popup_bg, s:blue, "")
call s:h("NormalFloat", s:fg, s:popup_bg, "")
call s:h("FloatBorder", s:popup_border, s:popup_bg, "")
call s:h("FloatShadow", "", s:bg, "")
call s:h("FloatShadowThrough", "", s:bg, "")
call s:h("LspInfoBorder", s:popup_border, s:popup_bg, "")
call s:h("LspFloatWinNormal", s:fg, s:popup_bg, "")
call s:h("LspFloatWinBorder", s:popup_border, s:popup_bg, "")
call s:h("DiagnosticFloatingError", s:red, s:popup_bg, "")
call s:h("DiagnosticFloatingWarn", s:yellow, s:popup_bg, "")
call s:h("DiagnosticFloatingInfo", s:blue, s:popup_bg, "")
call s:h("DiagnosticFloatingHint", s:cyan, s:popup_bg, "")
call s:h("CmpDocumentation", s:fg, s:popup_bg, "")
call s:h("CmpDocumentationBorder", s:popup_border, s:popup_bg, "")
call s:h("FloatTitle", s:fg, s:popup_bg, "bold")
...
call s:h("BlinkCmpLabelDetail", s:comment_fg, "", "")
call s:h("BlinkCmpLabelDescription", s:comment_fg, "", "")
call s:h("BlinkCmpSource", s:purple, "", "")
call s:h("BlinkCmpKind", s:cyan, "", "")
call s:h("BlinkCmpGhostText", s:non_text, "", "italic")
call s:h("BlinkCmpScrollBarThumb", "", s:popup_border, "")
call s:h("BlinkCmpScrollBarGutter", "", s:popup_selection, "")
call s:h("BlinkCmpMenu", s:fg, s:popup_bg, "")
call s:h("BlinkCmpMenuBorder", s:popup_border, s:popup_bg, "")
call s:h("BlinkCmpMenuSelection", s:popup_bg, s:blue, "")
call s:h("BlinkCmpDoc", s:fg, s:popup_bg, "")
call s:h("BlinkCmpDocBorder", s:popup_border, s:popup_bg, "")
call s:h("BlinkCmpDocSeparator", s:popup_border, s:popup_bg, "")
call s:h("BlinkCmpDocCursorLine", s:fg, s:popup_selection, "")
call s:h("BlinkCmpSignatureHelp", s:fg, s:popup_bg, "")
call s:h("BlinkCmpSignatureHelpBorder", s:popup_border, s:popup_bg, "")
...
call s:h("LspSignatureActiveParameter", s:yellow, "", "bold")
