...
call s:h("PmenuBorder", s:hoverborder, s:bg, "")
call s:h("NormalFloat", s:fg, s:bg, "")
call s:h("FloatBorder", s:hoverborder, s:bg, "")
call s:h("LspInfoBorder", s:hoverborder, s:bg, "")
call s:h("DiagnosticFloatingError", s:red, s:bg, "")
call s:h("DiagnosticFloatingWarn", s:yellow, s:bg, "")
call s:h("DiagnosticFloatingInfo", s:blue, s:bg, "")
call s:h("DiagnosticFloatingHint", s:cyan, s:bg, "")
call s:h("CmpDocumentation", s:fg, s:bg, "")
...
call s:h("BlinkCmpMenu", s:fg, s:bg, "")
call s:h("BlinkCmpMenuBorder", s:hoverborder, s:bg, "")
call s:h("BlinkCmpMenuSelection", s:bg, s:blue, "")
call s:h("BlinkCmpDoc", s:fg, s:bg, "")
call s:h("BlinkCmpDocBorder", s:hoverborder, s:bg, "")
call s:h("BlinkCmpDocSeparator", s:hoverborder, s:bg, "")
