...
ln -sf ~/<PATH_TO_DOTFILES>/dotfiles/nvim  ~/.config/nvim
ln -sf ~/<PATH_TO_DOTFILES>/dotfiles/tmux  ~/.config/tmux
ln -sf ~/<PATH_TO_DOTFILES>/dotfiles/starship ~/.config/starship
